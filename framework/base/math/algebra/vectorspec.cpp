...
void CMVec3Pack01(CMVector3D<double> &vOut, const CMVector3D<double> &vIn)
{
    ...
    __m256d vprod = _mm_mul_pd(invreg,v05reg);
    __m256d outvreg = _mm_add_pd(vprod,v05reg);
...
void CMVec3Unpack01(CMVector3D<double> &vOut, const CMVector3D<double> &vIn)
{
    ...
    __m256d vprod = _mm_mul_pd(invreg,twovreg);
    __m256d outvreg = _mm_sub_pd(vprod,onevreg);
